class Game_board {
  constructor(_pairs, _maxarr, _doubled, _freeze, _arr, _Creating_a_div, _Two_numbers_use,
    _game_type, _style, _on_or_off, _random, _frontDiv, _rowDiv, _size, _parentDiv,
    _player_one_Guess, _rounds, _player_two_Guess, _player_bot_Guess, _Out_of_cards,
    ...
    _board_size, _rows, _cols, _player_one_moves, _show_all_cards, _max_show_all_cards, _eye) {
    this.pairs = _pairs;
    this.maxarr = _maxarr;
